...
\chapter{Analiza i~porównanie wybranych algorytmów}\label{Section_Algorytmy}
  ...
  \section{Algorytmy oparte o~przepływ optyczny}\label{Subsection_OpticalFlow}
    ...
    \] następnie, po przektszałceniu otrzymamy: \[
